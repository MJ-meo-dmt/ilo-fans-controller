...
<p align="center">
  Extended version by <a href="https://github.com/MJ-meo-dmt"><strong>MJ-meo-dmt</strong></a>
</p>

> `ilo-fans-controller-v2_index.php` is an extended version of the original iLO Fans Controller.
>
> This version adds live temperature readings, a compact temperature dashboard, top hottest sensor summary, fan auto-refresh, optional iLO direct/tunnel links, thermal failsafe support, startup preset support, and CLI/systemd automation.

<p align="center">
  <img width="800" src="screenshot_extended.png" alt="Extended iLO Fans Controller dashboard screenshot">
  <br>
...
- [Features added in this extended version](#features-added-in-this-extended-version)
...
## Features added in this extended version
